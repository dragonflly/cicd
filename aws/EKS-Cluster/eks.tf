#############################################################################
# Input Variables for EKS Cluster
...
resource "aws_eks_cluster" "eks_cluster" {
  ...
  # Enable EKS Cluster Control Plane Logging in CloudWatch
...
resource "aws_eks_node_group" "eks_ng_private" {
  ...
  version = var.cluster_version # (Optional: Defaults to EKS Cluster version)    
